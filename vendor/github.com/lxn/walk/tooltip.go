...
func (tt *ToolTip) addTool(hwnd win.HWND, track bool) error {
	...
	// Windows 11 can reject TTM_ADDTOOL for child controls (lxn/walk#805).
	// Tooltips are optional for this application, so skip registration rather
	// than preventing the entire form from being created.
